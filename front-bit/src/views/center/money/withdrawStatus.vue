...
<template>
  <div class="center recharge p-footer">
    ...
    <van-cell-group :border="false" class="mt-4">
      ...
      <van-cell center>
        <template #title>
          <span class="color-light"
            >提现数量({{ order.bitType | filterBitType }})</span
          >
        </template>
        <template #default>
      ...
      <van-cell center>
        <template #title>
          <span class="color-light">手续费({{ order.bitType | filterBitType }})</span>
        </template>
        <template #default>
          <span class="fs-12 color-main"
            >{{ order.fei || 0 }}</span
          >
        </template>
      </van-cell>
        ...
        <van-cell center>
          ...
          <template #default>
            <span class="fs-12 fw-b"
              >{{ order.bitType | filterBitType }}钱包</span
            >
          </template>
        </van-cell>
        <van-cell center>
