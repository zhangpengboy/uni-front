const cdn = {
  js: [
    'https://app.static.lanceyi.com/static/js/vue/vue.min.js',
    'https://app.static.lanceyi.com/static/js/vuex/vuex.min.js',
    'https://app.static.lanceyi.com/static/js/vue-router/vue-router.min.js',
    'https://app.static.lanceyi.com/static/js/lodash/lodash.min.js',
    'https://app.static.lanceyi.com/static/js/vue-baidu-map/index.min.js'
  ],
  css: [
  ...
  devServer: {
    ...
    proxy: {
      [process.env.VUE_APP_BASE_URL]: {
        ...
        target: 'https://test.lanceyi.com', // 测试地址
        // ws: true,
