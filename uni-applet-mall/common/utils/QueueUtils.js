...
module.exports = {
	...
	//分享海报背景图
	fxBgImg() {
		return this.publicCdnHost() + '/images/inviteCode/bg%402x.png'
	},
	//365充值分享海报图
	vipFxImg() {
		return this.publicCdnHost() + '/images/2021/10/25/fd763ce74897e08db9ab7cb1411862d1.png'
	},
	//全局域名
	publicYuMing() {
		// 测试
		return 'https://lz.test-wap.seprain.com'
		// 正式
	...
	// 全局webview嵌套页面
	webviewYuMing(uri) {
		return this.publicYuMing() + '/webview/' + uri;
	},
	// 退出登录
	logout() {
		this.remove("openId");
