<template>
	<view class="container">
		<view style="text-align: center;">
			<image style="width: 400upx;height: 400upx;margin-top: 140upx;border-radius:20upx"
				src="/static/img/logo.png"></image>
			<view style="font-size: 28upx;margin-top: 32upx;margin-bottom: 32upx;">国内优质牛肉供应购物平台</view>
