      ...
      <el-row :gutter="20">
        <el-col :span="22" :offset="2">
          ...
          <el-button
            ...
            >保存, 提交<i class="el-icon-check el-icon--right"></i
          ></el-button>
          <el-button
            type="success"
            size="default"
            ...
            @click="backGoodsList"
            v-loading.fullscreen.lock="fullscreenLoading"
            >返回，商品列表<i class="el-icon-arrow-right el-icon--right"></i
          ></el-button>
        </el-col>
      </el-row>
    </el-card>
...
import { storeGoodsBaseSkuBatchOt, updateGoods } from "@/api/goods";
export default {
  name: "GoodsInfoForm",
  props: {
    // 是否修改
  ...
  methods: {
    ...
    submitNextForm() {
      ...
      storeGoodsBaseSkuBatchOt(_data).then((res) => {
        this.fullscreenLoading = false;
        this.msgSuccess(res.message);
        this.$emit("reset");
        this.$store.dispatch("tagsView/delView", this.$route);
        this.$router.push({ name: "ConvenienceStoreBasis" });
      });
      setTimeout(() => {
        this.fullscreenLoading = false;
      }, 2000);
