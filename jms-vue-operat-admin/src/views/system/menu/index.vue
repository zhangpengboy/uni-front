<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="permission" label="权限标识" :show-overflow-tooltip="true" align="center"></el-table-column>
    ...
    <!-- 添加或修改菜单对话框 -->
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body v-el-dialog-drag>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        seq: [{ required: true, message: "菜单顺序不能为空", trigger: "blur" }],
        path: [
  ...
  methods: {
    ...
    handleAdd(row) {
      ...
      this.form.versionId = this.queryParams.versionId;
      this.open = true;
      this.title = "添加菜单";
    },
    /** 修改按钮操作 */
