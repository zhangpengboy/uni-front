...
<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="选择货架" prop="storeIds">
...
<script>
import { pushGoodsToStore, updatePushGoods } from "@/api/goods";
      ...
      this.$refs["cloudPushForm"].validate((valid) => {
        if (valid) {
          ...
          if (_params.id != undefined) {
            ...
            pushGoodsToStore(_params).then((response) => {
