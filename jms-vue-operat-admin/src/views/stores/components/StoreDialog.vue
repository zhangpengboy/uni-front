...
<template>
  ...
  >
    <el-form ref="storeForm" :model="form" label-width="100px" label-suffix=":">
      <el-row :gutter="20">
        ...
        <el-col
          :xs="24"
          :sm="12"
          :md="form.storeRoleCode == 3 || form.storeRoleCode == 5 ? 6 : 12"
          :lg="form.storeRoleCode == 3 || form.storeRoleCode == 5 ? 6 : 12"
          :xl="form.storeRoleCode == 3 || form.storeRoleCode == 5 ? 6 : 12"
        >
          <el-form-item
            label="店铺角色"
            :rules="[
    ...
    <div slot="footer" class="dialog-footer">
      <el-button v-if="isEdit" type="primary" @click="submitForm" size="mini"
        >审 核</el-button
      >
