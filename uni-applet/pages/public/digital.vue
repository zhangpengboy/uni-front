<template>
	<view style="font-size: 14px;line-height: 26px;padding: 32upx;background: #FFFFFF;" class="home1">
		<view style="
			...
			<view style="text-align: left; text-indent: 2rem">
				1、用户在申请使用惠有福的网络服务时，必须向软件提供真实、准确的个人资料，进行注册。如个人资料有变动，及时更新。
			</view>
			<view style="text-align: left; text-indent: 2rem">
			...
			<view style="text-align: left; text-indent: 2rem">
				（4）不得利用惠有福的网络服务系统进行任何可能对互联网的正常运转造成不利影响的行为；
			</view>
			<view style="text-align: left; text-indent: 2rem">
				（5）不得利用惠有福的网络服务系统传输任何骚扰、诱导、欺骗、辱骂、恐吓、庸俗、淫秽的或其他任何非法的信息资料；
			</view>
			<view style="text-align: left; text-indent: 2rem">
				（6）不得利用惠有福的网络服务系统进行任何不利于国家、社会、人民及公民个人的行为；
			</view>
			<view style="text-align: left; text-indent: 2rem">
				（7）用户如发现有任何非法使用帐号或帐号出现安全漏洞的情况，应立即通报惠有福。
			</view>
			<view style="font-size: 16px; font-weight: bold">五、内容所有权</view>
			<view style="text-align: left; text-indent: 2rem">
				1、惠有福提供的网络服务内容包括：文字、软件、声音、图片、录像、图表等。所有这些内容都受版权、商标权、著作权和其它财产所有权的法律保护。
			</view>
			<view style="text-align: left; text-indent: 2rem">
			...
			<view style="text-align: left; text-indent: 2rem">
				1、为了保护用户隐私权，惠有福绝对对用户的个人信息实行保密。软件保证不对外公开或向第三方提供用户的注册资料，及用户在使用网络服务时存储在云端的非公开内容。但下列情况除外：
			</view>
			<view style="text-align: left; text-indent: 2rem">
				（1）事先获得用户的明确授权
			</view>
			...
			<view style="text-align: left; text-indent: 2rem">
				2、如发生下列任何一种情形，惠有福有权随时中断或终止向用户提供本协议项下的网络服务而无需通知用户：
			</view>
			<view style="text-align: left; text-indent: 2rem">
				（1）用户提供的个人资料不真实；
			</view>
			...
			<view style="text-align: left; text-indent: 2rem">
				1、用户同意保障和维护软件及其他用户的利益，如因用户违反有关法律、法规或本协议的任何条款，而给惠有福或任何其他第三人造成损失，用户同意承担由此造成损害的赔偿责任。
			</view>
			...
			<view style="text-align: left; text-indent: 2rem">
				（2）在惠有福的网页上发布信息或者利用网易的服务时还必须符合其他有关国家和地区的法律规定以及国际法的有关规定。
			</view>
			<view style="text-align: left; text-indent: 2rem">
				（3）不利用惠有福的服务从事以下活动：
			</view>
			...
			<view style="text-align: left; text-indent: 2rem">
				用户需对自己在使用惠有福服务过程中的行为承担法律责任。如果惠有福发现其软件传输的信息明显属于用户管理第
			</view>
			<view style="text-align: left; text-indent: 2rem">
