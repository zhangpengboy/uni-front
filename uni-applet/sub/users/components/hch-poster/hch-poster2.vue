...
<template>
  <view
    ...
    :style="'width:' + system.w + 'px; height:' + system.h + 'px;'"
		@click.stop.prevent="handleCanvasCancel"
  >
    <!-- 遮罩层 -->
    ...
    computed: {
      ...
      userImg() {
        ...
        let posterUser = {
          ...
          x: this.mainImg.x + 15 * system.scale,
          y: this.mainImg.y + this.mainImg.h + data.title.mt * system.scale + data.userImg.mt * system.scale  //y需要加上绘图后文本的y
        }
        return posterUser
      },
			/**
			...
			textBg() {
				...
				let textBg = {
					...
					x: this.mainImg.x + 10 * system.scale,
