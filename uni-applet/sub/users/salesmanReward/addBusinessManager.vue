<template>
	<view class="list">
		<view class="row">
			<view class="title"><text style="color: #F53232; margin: 0rpx 8upx 0rpx 0;">*</text><text>业务经理手机号</text></view>
			<view class="right">
				<view class="rightinp">
					<input v-model="leaderPhone" value="" placeholder="请输业务经理手机号"
	...
	export default {
		...
		methods: {
			...
			forgetPwd() {
				...
				this.$http.bindRelationByPhone(obj).then(res => {
					uni.hideLoading()
					if (res.code == 200) {
