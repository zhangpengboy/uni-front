 ...
 * @LastEditTime: 2021-10-21 16:03:53
...
const service = axios.create({
  ...
  // baseURL: "https://test.lanceyi.com",
  // baseURL: "https://shop.lanceyi.com/prod-api",
  // 超时
  timeout: 100000,
  // 默认请求方式
  method: "POST"
...
service.interceptors.request.use(config => {
  ...
  if (getToken() && !isToken) {
    config.headers['store-token'] = 'Bearer ' + getToken() // 让每个请求携带自定义token 请根据实际情况自行修改
  }
  return config
}, error => {
  console.log(error)
