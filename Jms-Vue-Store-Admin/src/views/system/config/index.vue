 ...
 * @LastEditTime: 2021-04-14 15:01:28
        ...
        >
          <template slot-scope="scope">
            <span v-if="v.prop === 'appDown' || v.prop === 'branchCtl'">
              <i
                class="iconfont srjtcheckboxoutline fs-20"
    ...
    >
      ...
      >
        ...
        <el-form-item label="附加配置" required>
          <el-checkbox v-model="form.appDown" :true-label="1" :false-label="0"
            >是否线下使用</el-checkbox
          >
          <el-checkbox v-model="form.branchCtl" :true-label="1" :false-label="0"
            >是否控制分店</el-checkbox
          >
        </el-form-item>
      </el-form>
