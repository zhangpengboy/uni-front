const cdn = {
  ...
  css: ['https://ytb.static.lanceyi.com/static/css/app-reset.min.css']
}
module.exports = {
  publicPath: process.env.NODE_ENV === 'production' ? './' : '/', // 基本路径
  outputDir: '../mall', // 输出文件目录
  assetsDir: 'static',
  ...
  devServer: {
    ...
    proxy: {
      [process.env.VUE_APP_BASE_URL]: {
        // target: 'https://myapi1.cn.utools.club', // 内网地址
        // target: 'https://mth-gzh.lanceyi.com', // 内网地址
