<template>
	<div style="font-size: 14px;line-height: 26px;padding: 16px;background: #FFFFFF;" class="home1">
		<div
		>
			<div style="text-align: left; text-indent: 0.7rem">
			...
			<div style="text-align: left; text-indent: 0.7rem">本软件无收费项</div> -->
			<div style="font-weight: bold; text-align: left; text-indent: 0.7rem">
				本协议自签订之日起生效。
