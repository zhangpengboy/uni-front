...
const getWeixinCode = () => {
  ...
  // 'https://mth-gzh.meitianhui.com'  https://myapp.cn.utools.club
  axios.post(apiUri.APP_MALLUSER_AUTH, { url: window.location.href }, res => {
...
// 全局CDN域名
const publicCdnHost = () => {
  return 'https://ytb.static.lanceyi.com'
}
