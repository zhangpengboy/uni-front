...
// 创建购物车订单
export const addCartOrder = (data) => {
	return fetch.post('/api-order/orderV2/addCartOrder', data);
}
...
// }
// 街市订单删除
export const streetOrderDelete = (data) => {
	return fetch.post('/api-order/streetOrder/delete', data);
}
export default {
	createRechargeOrder,
