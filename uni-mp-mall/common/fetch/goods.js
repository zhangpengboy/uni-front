...
// 街市商品列表
export const streetGoodsList = (data) => {
	return fetch.post('/api-goods/streetGoods/admin/pageList', data);
}
// 街市店铺商品列表
export const streetGoodsPageList = (data) => {
	return fetch.post('/api-goods/streetGoods/store/pageList', data);
}
// 街市商品列详情
export const streetGoodsDetail = (data) => {
	return fetch.post('/api-goods/streetGoods/detail', data);
}
// 查询小程序首页街市商品列表
export const getStreetGoodsList = (data) => {
	return fetch.post('/api-goods/streetGoods/getStreetGoodsList', data);
}
