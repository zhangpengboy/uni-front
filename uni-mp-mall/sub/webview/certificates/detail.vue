		...
		data() {
			return {
				imgs: [{
						poa: 0,
						tetle: "收款金额  (元)",
						img: `${this.$queue.publicCdnHost()}/assets/imgs/paymentAmount.png`
					},
					{
						poa: 0,
						tetle: "交易笔数 (笔)",
						img: `${this.$queue.publicCdnHost()}/assets/imgs/numberOfTransactions.png`
					},
					{
						poa: 0,
						tetle: "赠送礼券 (个)",
						img: `${this.$queue.publicCdnHost()}/assets/imgs/giftCertificates.png`
					},
					{
						poa: 0,
						tetle: "购买礼券金额 (元)",
						img: `${this.$queue.publicCdnHost()}/assets/imgs/buyGiftCertificates.png`
					},
					{
						poa: 0,
						tetle: "剩余礼券 (个)",
						img: `${this.$queue.publicCdnHost()}/assets/imgs/remainingCoupon.png`
					},
				],
