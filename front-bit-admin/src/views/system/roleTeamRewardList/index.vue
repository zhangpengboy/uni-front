  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="团长最高奖励" required  prop="teamReward">
          <el-input v-model="form.teamReward" type="number" placeholder="请输入团长最高奖励比例" />
        </el-form-item>
...
<script>
import { getRoleTeamRewardList, addAndUpdateTeamReward } from "@/api/system";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        teamReward: [
          { required: true, message: "团长最高奖励不能为空", trigger: "blur" },
        ],
      },
    };
  },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      getRoleTeamRewardList(this.queryParams).then((response) => {
      ...
      this.$refs["bitTypeForm"].validate((valid) => {
        if (valid) {
          if (this.form.id != undefined) {
            ...
            addAndUpdateTeamReward(this.form).then((response) => {
              if (response.success) {
